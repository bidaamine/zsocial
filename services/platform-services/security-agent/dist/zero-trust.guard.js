...
var ZeroTrustGuard_1;
Object.defineProperty(exports, "__esModule", { value: true });
exports.ZeroTrustGuard = void 0;
const common_1 = require("@nestjs/common");
const jwt = __importStar(require("jsonwebtoken"));
const threat_detection_service_1 = require("./threat-detection.service");
let ZeroTrustGuard = ZeroTrustGuard_1 = class ZeroTrustGuard {
    threatDetectionService;
    logger = new common_1.Logger(ZeroTrustGuard_1.name);
    ...
    async canActivate(context) {
        ...
        if (type !== 'Bearer' || !token) {
            ...
            throw new common_1.UnauthorizedException('Zero-Trust Policy: Invalid token format');
        }
        try {
            ...
            if (riskScore >= 70) {
                ...
                throw new common_1.ForbiddenException(`Zero-Trust Policy Block: Request blocked due to high threat risk score (${riskScore})`);
            }
...
exports.ZeroTrustGuard = ZeroTrustGuard = ZeroTrustGuard_1 = __decorate([
